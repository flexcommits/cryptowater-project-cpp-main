...
#        body += '</table>'
    ...
    def handle_addresses(self,chain,params,nparams):
        ...
        if last is None:
            return self.standard_response('<div class="alert alert-danger" role="alert">Explorer APIs are not enabled. To enable them, please run "testchaind -explorersupport=1 -rescan"</div>')
...
#                body += '<td><span class="label label-warning">Not Local</span></td>'                                        
    ...
    def handle_assetissues(self,chain,params,nparams):
        ...
        if 'issuecount' not in response['result'][0]:
            return self.standard_response('<div class="alert alert-danger" role="warning">Not supported in this version of DropCoin</div>')
